...
DeviceHW._relations += (("iostates", ToManyCont(ToOne, "ZenPacks.community.IOStat.IOStat", "hw")), )
...
#                addPlugins(dmd.Devices.Server.Windows)
    ...
    def _cleanupOurPlugins(self, dmd):
        self._cleanupCollectorPlugins(dmd, ('IOStatMap'))
